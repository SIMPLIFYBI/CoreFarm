...
export function PlodCreateSheet({
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-y-0 right-0 w-full sm:w-[520px] bg-slate-950/95 backdrop-blur-xl shadow-2xl border-l border-white/10">
                ...
                <div className="grid grid-cols-1 gap-3 mt-3">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setActivityForm((s) => ({ ...s, activity_type_id: e.target.value }))}
                    >
