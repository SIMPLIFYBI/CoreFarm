...
function CompassOrientationCard({ azimuth }) {
  ...
  return (
    <div className="rounded-[24px] border border-cyan-300/15 bg-[linear-gradient(135deg,rgba(15,23,42,0.88),rgba(8,47,73,0.58)_52%,rgba(15,23,42,0.9))] p-4 shadow-[0_18px_50px_rgba(2,6,23,0.28)]">
      <div className="text-[11px] uppercase tracking-[0.22em] text-cyan-100/80">Azimuth</div>
      <div className="mt-3 flex flex-col items-start gap-4 min-[420px]:flex-row min-[420px]:items-center">
        <div className="relative h-20 w-20 shrink-0 rounded-full border border-white/10 bg-slate-950/55">
          ...
          <div className="pointer-events-none absolute inset-x-0 top-1 text-center text-[10px] font-semibold uppercase tracking-[0.24em] text-slate-400">N</div>
        </div>
        <div className="min-w-0">
          <div className="text-2xl font-semibold text-white">{formatAngle(azimuth)}</div>
          <div className="mt-1 text-sm text-slate-300">Bearing from north</div>
          <div className="mt-2 inline-flex rounded-full border border-white/10 bg-white/[0.05] px-3 py-1 text-xs text-slate-300">
...
function DipOrientationCard({ dip }) {
  ...
  return (
    <div className="rounded-[24px] border border-amber-300/15 bg-[linear-gradient(135deg,rgba(15,23,42,0.92),rgba(120,53,15,0.36)_58%,rgba(15,23,42,0.92))] p-4 shadow-[0_18px_50px_rgba(2,6,23,0.28)]">
      <div className="text-[11px] uppercase tracking-[0.22em] text-amber-100/80">Dip</div>
      <div className="mt-3 flex flex-col items-start gap-4 min-[420px]:flex-row min-[420px]:items-center">
        <div className="relative flex h-20 w-24 shrink-0 items-center justify-center rounded-[20px] border border-white/10 bg-slate-950/55">
        ...
        <div className="min-w-0">
          <div className="text-2xl font-semibold text-white">{formatAngle(dip)}</div>
          <div className="mt-1 text-sm text-slate-300">Inclination from horizontal</div>
          <div className="mt-2 inline-flex rounded-full border border-white/10 bg-white/[0.05] px-3 py-1 text-xs text-slate-300">
