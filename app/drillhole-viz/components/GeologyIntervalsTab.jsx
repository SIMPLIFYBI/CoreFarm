        ...
        <div className="glass rounded-2xl border border-white/10 p-4 md:p-5 space-y-4">
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div className="min-w-0 space-y-1">
              <div className="text-sm font-semibold text-slate-100">Geology intervals</div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              >
                {geoSaving ? "Saving..." : "Save changes"}
              </button>
            </div>
          </div>

          {geoLoading ? (
            <div className="glass rounded-xl border border-white/10 p-3 text-sm text-slate-300">Loading geology...</div>
            ...
            <div className="space-y-3">
              ...
              {(geoRows || []).map((r, idx) => {
                ...
                return (
                  <div key={r.id || `new-${idx}`} className="rounded-xl border border-white/10 bg-white/[0.04] p-3">
                    <div className="grid grid-cols-1 md:grid-cols-[minmax(92px,1fr)_minmax(92px,1fr)_minmax(0,2.6fr)_48px] gap-3 items-end">
                      ...
                      <div className="min-w-0">
                        <label className="mb-1 block text-[11px] uppercase tracking-wide text-slate-400">Lithology Type</label>
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          >
                            <option value="">Choose lithology</option>
